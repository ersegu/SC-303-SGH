...
import com.mycompany.clienteservidorg6sistemagestionhospitalaria.Usuario;
...
public class RegistrarUsuario extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (user.registrarUsuario(user)) {
            JOptionPane.showMessageDialog(this, "Registro de Usuario exitoso", "Registar Usuario", JOptionPane.INFORMATION_MESSAGE);
            limpiar();
        } else {
